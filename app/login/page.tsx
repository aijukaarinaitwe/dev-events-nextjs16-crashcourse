...
function LoginFormContent() {
    ...
    const redirectUrl = searchParams.get('redirect') || (isAdminMode ? '/admin/events' : '/');
    ...
    return (
        <>
            <div className="text-center mb-8">
                <h1 className="text-4xl text-gradient">{isAdminMode ? 'Admin Sign In' : 'Welcome Back'}</h1>
                <p className="text-light-200 mt-2">
                    {isAdminMode ? 'Enter the admin password to continue.' : 'Sign in to book events and manage registrations.'}
                </p>
            </div>
